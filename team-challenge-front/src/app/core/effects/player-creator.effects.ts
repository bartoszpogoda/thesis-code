...
import {PlayerCreatorActionTypes, Register, RegisterFailure, RegisterSuccess, UploadAvatarSuccess} from '../actions/player-creator.actions';
import {SetHomeSuccess, TeamCreatorActionTypes} from '../actions/team-creator.actions';
import {successMessageEffect} from '../util/functions';
